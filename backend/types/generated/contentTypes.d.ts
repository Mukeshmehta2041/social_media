...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Categories for advertisements';
...
export interface ApiCityCity extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Cities for advertisements';
    displayName: 'City';
    pluralName: 'cities';
    singularName: 'city';
  };
...
export interface ApiReportReport extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Reports for inappropriate content';
    displayName: 'Report';
    pluralName: 'reports';
    singularName: 'report';
  };
  ...
  attributes: {
    ...
    reason: Schema.Attribute.Enumeration<
      ['spam', 'inappropriate', 'fraud', 'duplicate', 'other']
    > &
      Schema.Attribute.Required;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    advertisements: Schema.Attribute.Relation<
      ...
      'api::advertisement.advertisement'
    >;
    ageVerified: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    ...
    contactForms: Schema.Attribute.Relation<
      'oneToMany',
      'api::contact-form.contact-form'
    >;
    createdAt: Schema.Attribute.DateTime;
    ...
    role: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    savedSearches: Schema.Attribute.Relation<
      'oneToMany',
      'api::saved-search.saved-search'
    >;
    updatedAt: Schema.Attribute.DateTime;
